...
daftar_nilai = { 
"Matematika": {"Ani": 74,"Anto": 77,"Budi": 98,"Bunga": 90,"Chandra": 40,"Cinta": 54,"Danang": 86,"Donita": 98,"Einstein": 99,"Elisa": 76},
...
for subject, dict_nilai in daftar_nilai.items():
    highest_score = 0
    highest_achiever = ""
    for name, nilai in dict_nilai.items():
        if nilai > highest_score:
            highest_achiever = name
            highest_score = nilai
    print(f"Nilai tertinggi untuk mata perlajaran {subject} diraih oleh {highest_achiever}")